...
> Bundled in the original skill (not included in this repo copy): lib/, run.js, package.json, API_REFERENCE.md — fetch from the upstream `source:` for the runnable assets.
