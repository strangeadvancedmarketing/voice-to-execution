...
> NOTE: disabled by the `_DISABLED_` directory-name prefix — the harness skips loading it. Rename the folder to `brand-guidelines-sentry` to enable. Sentry-specific example content; swap for your own brand.
