...
> Source: community skill (imported).

> Bundled in the original skill (not included in this repo copy): reference/, scripts/ — fetch from the upstream `source:` for the runnable assets.
